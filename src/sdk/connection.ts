...
export class Connection {
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.connectionRead = utils.objectToClass(httpRes?.data, shared.ConnectionRead);
                }
                break;
    ...
    async resetConnection(
        ...
        const res: operations.ResetConnectionResponse = new operations.ResetConnectionResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async searchConnections(
        ...
        const res: operations.SearchConnectionsResponse = new operations.SearchConnectionsResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async syncConnection(
        ...
        const res: operations.SyncConnectionResponse = new operations.SyncConnectionResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
